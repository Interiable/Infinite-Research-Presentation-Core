...
final_md = "\n".join(toc_lines) + "\n\n---\n\n" + all_combined
save_path = save_artifact("Project_Raw_Concatenated_Report_Cleaned", final_md, "md", thread_id=thread_id)
print(f"✅ Saved Project_Raw_Concatenated_Report_Cleaned.md at {save_path}")
